...
class UserFriendshipsControllerTest < ActionController::TestCase
  context "#index" do
    ...
    context "when logged in" do
      setup do
        @friendship1 = create(:pending_user_friendship, user: users(:sean), friend: create(:user, first_name: 'Pending', last_name: 'Friend'))
        @friendship2 = create(:accepted_user_friendship, user: users(:sean), friend: create(:user, first_name: 'Active', last_name: 'Friend'))
        @friendship3 = create(:requested_user_friendship, user: users(:sean), friend: create(:user, first_name: 'Requested', last_name: 'Friend'))
        @friendship4 = user_friendships(:blocked_by_sean)
  ...
  context "#new" do
    ...
    context "when logged in" do
      ...
      should "display the friend's name" do
        get :new, friend_id: users(:tragnark)
        assert_match /#{users(:tragnark).full_name}/, response.body
      end
      ...
      should "assign a new user friendship to the correct friend" do
        get :new, friend_id: users(:tragnark)
        assert_equal users(:tragnark), assigns(:user_friendship).friend
      end
      ...
      should "ask if you really want to friend the user" do
        get :new, friend_id: users(:tragnark)
        assert_match /Do you really want to friend #{users(:tragnark).full_name}?/, response.body
      end
    end
  end
  ...
  context "#accept" do
    ...
    context "when logged in" do
      setup do
        @friend = create(:user)
        @user_friendship = create(:pending_user_friendship, user: users(:sean), friend: @friend)
        create(:pending_user_friendship, friend: users(:sean), user: @friend)
        sign_in users(:sean)
  ...
  context "#edit" do
    ...
    context "when logged in" do
      setup do
        @user_friendship = create(:pending_user_friendship, user: users(:sean))
        sign_in users(:sean)
  ...
  context "#destroy" do
    ...
    context "when logged in" do
      setup do
        @friend = create(:user)
        @user_friendship = create(:accepted_user_friendship, friend: @friend, user: users(:sean))
        create(:accepted_user_friendship, friend: users(:sean), user: @friend)
